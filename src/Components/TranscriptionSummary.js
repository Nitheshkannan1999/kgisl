...
const SummaryText = () => (
  <p>
    ...
    but the problem kept happening. Was suggested to wait some couple hours to
    restore the signal into the area, but the customer was impatient.
  </p>
);
...
const TranscriptionToggle = ({ showExpandedView, toggleExpandedView }) => (
